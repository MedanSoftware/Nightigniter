...
|
*/
$config['rest_debug_field_name'] = 'data';

/*
|--------------------------------------------------------------------------
| REST Debug Field Name
|--------------------------------------------------------------------------
|
| The field name for the debug inside the response
|
*/
$config['rest_debug_field_name'] = 'debug';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_key_name'] = 'NIGHTIGNITER-API-KEY';
